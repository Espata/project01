		...
		<div id="layoutSidenav_content" style="padding-left: 0px;">
			<main>
				<div class="container-fluid px-4">
					...
					<p>100) Human error: Errors caused by human mistake</p>
					<p>ex) Fingerprints on the wafer</p>
					<p>200) Measuring environment error: Errors depending on the
						measuring environment</p>
					<p>ex) Temperature or humidity in the measurement room</p>
					<p>300) Material error: Defect in the silicon itself</p>
					<p>ex) Impurities mixed with the wafer or scratched the wafer</p>
					<p>400) Mechanical error: Errors due to machine set value
						changes and malfunctions</p>
					<p>ex) Laser setup problem or electrical problem</p>
				</div>
			</main>
		</div>
	</div>
